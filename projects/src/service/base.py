...
class IProjectService(IGenericService, ABC):
...
class IDefaultSectionService(IGenericService, ABC):
    """ Interface of DefaultSectionService. """

    def __init__(self, repository: REPO):
        """ Throws model into generic base. """
        super().__init__(
            repository=repository,
            in_schema=DefaultSectionIn,
            out_schema=DefaultSectionOut
        )


class ISectionService(IGenericService, ABC):
