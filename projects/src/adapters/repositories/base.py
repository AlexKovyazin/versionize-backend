...
from projects.src.adapters.orm import Base, OrmProject, OrmSection, OrmDefaultSection
...
class IProjectsRepository(IGenericRepository, ABC):
    def __init__(self, uow: AbstractUnitOfWork):
        """ Throws model into generic base. """
        super().__init__(uow, OrmProject)


class ISectionsRepository(IGenericRepository, ABC):
    def __init__(self, uow: AbstractUnitOfWork):
        """ Throws model into generic base. """
        super().__init__(uow, OrmSection)


class IDefaultSectionsRepository(IGenericRepository, ABC):
    def __init__(self, uow: AbstractUnitOfWork):
        """ Throws model into generic base. """
        super().__init__(uow, OrmDefaultSection)
