...
Revision ID: 31862dd732e4
Revises: 
Create Date: 2025-10-27 11:43:43.079432
...
def upgrade() -> None:
    ...
    sa.Column('project_type', sa.Enum('LINEAR', 'AREAL', name='projecttype'), nullable=False, comment='Тип объекта'),
