...
from notifications.src.adapters.repositories.base import IGenericRepository
...
class INotificationService(IGenericService, ABC):
    """ Interface of NotificationService. """

    def __init__(self, repository: REPO):
        """ Throws model into generic base. """
        super().__init__(
            repository=repository,
            in_schema=NotificationIn,
